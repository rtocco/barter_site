# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-14 04:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='barter.Chain')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            model_name='employee',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='barter.Store'),
        ),
    ]
